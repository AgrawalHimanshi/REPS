...
<div class="table-scrol">  
    <h1 align="center">Registered Candidate Details</h1>  
  
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
 
  
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed; color: black;" cellpadding='5px'; border="1px black";  >  
        <thead>  
        ...
        $view_users_query="select * from c_register";//select query for viewing users.  
